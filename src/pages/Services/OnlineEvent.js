        ...
        <div class="container">
            <div class="project-details-items">
                <div class="main-content">
                    ...
                    <h3>How Social Rajneeti Plans & Executes Online Event Management for Politicians</h3>
                    <p>For political online event management, social media provides outstanding channel that we use before, during and after the event. Our strategy for political online event management includes:</p>
                    ...
                    <p>To engage the audience during the event, Social Rajneeti uses Twitter to monitor the audience’s reaction to the political event or speaker. Live video streaming on Facebook and YouTube is an awesome real-time resource that we use to engage the people on the web who weren’t able to attend the event in person.</p>
                    <h3>After the Event:</h3>
                    <p>Even after the political event is over we make sure that the online conversation about your event is not over. Press coverage and feedback is a good way to keep people talking about your political event after is has happened. We share the media coverage gathered by your event on social media which helps to showcase how successful the event was. And, ask the online followers for feedback about the event. Whether, positive or negative we take their feedback into account to improve the experience for your next political online event management.</p>
